...
namespace Joy\VoyagerBreadDocument\Models;
...
use Joy\VoyagerBreadDocument\Database\Factories\DocumentFactory;
...
class Document extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Document'));
    }
