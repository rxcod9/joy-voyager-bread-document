...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function dataTypesTranslations()
    {
        ...
        $dtp = DataType::where($_fld, __('joy-voyager-bread-document::seeders.data_types.category.singular'))->firstOrFail();
        if ($dtp->exists) {
        ...
        $_tpl = ['data_types', $_fld];
        $dtp = DataType::where($_fld, __('joy-voyager-bread-document::seeders.data_types.category.plural'))->firstOrFail();
        if ($dtp->exists) {
    ...
    private function menusTranslations()
    {
        ...
        $_item = $this->findMenuItem(__('joy-voyager-bread-document::seeders.menu_items.documents'));
        if ($_item->exists) {
